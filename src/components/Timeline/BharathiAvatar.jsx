...
const BharathiAvatar = ({ state = 'idle', language }) => {
  return (
    <div className="bt-avatar-wrapper">
      <div className={`bt-avatar-container state-${state}`}>
        <svg className="bt-avatar-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="50" cy="50" r="45" fill="url(#glow)" className="avatar-glow-bg" />
          ...
          {/* Moustache */}
          <path className="avatar-mouth" d="M40,50 C45,48 55,48 60,50 C62,52 65,55 65,55 C65,55 55,52 50,52 C45,52 35,55 35,55 C35,55 38,52 40,50 Z" fill="#111"/>
        </svg>
      </div>
      <div className="bt-avatar-label">
        {language === 'ta' ? 'AI கற்பனை விளக்கம்' : 'AI INTERPRETATION'}
      </div>
    </div>
  );
};
